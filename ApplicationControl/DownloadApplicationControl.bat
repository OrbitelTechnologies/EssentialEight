...
powershell -command "& { Invoke-Webrequest "https://github.com/OrbitelTechnologies/EssentialEight/blob/bcb2048971032dc3b0969b2022622dd10c1b8472/ApplicationControl/WDAC/RefreshPolicy(AMD64).exe" -OutFile "C:\Orbitel\Scripts\E8\WDAC\RefreshPolicy(AMD64).exe" }"
