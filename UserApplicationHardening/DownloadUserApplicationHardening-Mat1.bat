...
SCHTASKS /CREATE /SC ONLOGON /TN "Orbitel\UserApplicationHardening\MaturityOne" /F /TR C:\Orbitel\Scripts\E8\UserApplicationHardening-Mat1.ps1 /RU INTERACTIVE /RL HIGHEST
